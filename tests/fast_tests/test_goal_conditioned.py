...
class TestSACGoalConditionedPolicy(unittest.TestCase):
    ...
    def test_cooperative_gradients(self):
        ...
        self.assertRaises(
            NotImplementedError,
            policy._cooperative_gradients_update,
            obs0=None, actions=None, rewards=None, obs1=None,
            terminals1=None, level_num=None)
