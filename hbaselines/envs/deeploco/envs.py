...
class BipedalObstacles(gym.Env):
    ...
    observation_space = gym.spaces.Box(
        low=5 * np.array(1024 * [-1.] + [0.06586086, -0.33134258, -0.22473772, -0.08842427, -0.24940665,
                                         ...
                                         -1.00000000, -1.00000000, -1.00000000, -1.00000000, -1.00000000,
                                         -1.00000000, -1.00000000, -1.00000000, -1.00000000, -1.00000000]),
        high=5 * np.array(1024 * [1.] + [0.61076754, 0.30874607, 0.16389988, 0.278528, 0.10735691,
    ...
    action_space = gym.spaces.Box(
        low=5 * np.array([-1.0, -1.0, -1.0, -0.5, -1.0, -1.0, -1.0, -2.57, -3.14,
                          -1.0, -1.0, -1.0, -1.57, -1.0, -1.0, -1.0, -2.57, -3.14,
                          -1.0, -1.0, -1.0, -1.57]),
        high=5 * np.array([1.0, 1.0, 1.0, 0.5, 1.0, 1.0, 1.0, 2.57, 0.5,
