...
from hbaselines.ppo.tile_images import tile_images
...
class VecEnv(ABC):
    ...
    observation becomes an batch of observations, and expected action is a
...
def clear_mpi_env_vars():
    """Call MPI_Init by default (from mpi4py import MPI).
